        ...
        <div className="bg-white border-b border-slate-100 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-red-500 font-medium">Configuration Required</p>
            </div>
          </div>
        </div>
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-md">
            <p className="text-slate-600 mb-4">
              The Habibi Chat assistant requires a Google Gemini API key to function.
            </p>
            <p className="text-sm text-slate-500 bg-slate-50 p-4 rounded-lg">
              Please add your <code className="font-mono bg-white px-2 py-1 rounded">GEMINI_API_KEY</code> to the <code className="font-mono bg-white px-2 py-1 rounded">.env</code> file and restart the server.
              <br /><br />
              Get your API key at: <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">aistudio.google.com/app/apikey</a>
            </p>
          </div>
        </div>
      </div>
